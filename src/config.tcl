...
set ::env(DESIGN_NAME) scan_wrapper_341521390605697619
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341521390605697619.v \
$::env(DESIGN_DIR)/scan_wrapper_341521390605697619.v"
